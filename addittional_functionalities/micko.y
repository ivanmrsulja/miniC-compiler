...
%type <i> function_call argument rel_exp if_part indexing
...
variable
  ...
  | _ID _LSQBRACKET _INT_NUMBER _RSQBRACKET _SEMICOLON
    {
      int arr_size = atoi($3);
      if (arr_size < 1){
      ...
      insert_symbol($1, VAR, type_capture, ++var_num, INITIALISED);
